...
namespace loss {
    std::pair<float, math::Matrix> l1(const std::unique_ptr<math::Matrix> &y_out,
                                      const std::unique_ptr<math::Matrix> &y_truth) {
    ...
    std::pair<float, math::Matrix> l2(const std::unique_ptr<math::Matrix> &y_out,
                                      const std::unique_ptr<math::Matrix> &y_truth) {
        math::Matrix diff = *y_out - *y_truth;
    ...
    std::pair<float, math::Matrix> cross_entropy(const std::unique_ptr<math::Matrix> &y_out,
                                                 const std::unique_ptr<math::Matrix> &y_truth) {
